public class Lv1RivalPokemon extends Lv1Pokemon implements Dodge{
    ...
    //设置精灵属性技能
    protected Lv1RivalPokemon(String name, int hp, int atk, int def){
        this.name=name;
        this.atk=atk;
        this.hp=hp;
        this.def=def;
    ...
    //技能战斗方法
    private void fight1(Lv1MyPokemon mp){
    ...
    private void fight4(Lv1MyPokemon mp){
        System.out.println(this.name+"对"+mp.name+"使用了"+skill1[3]+"，效果拔群，造成了"+(this.atk+100-mp.def)*2+"点伤害\n");
        mp.hp-=(this.atk+100-mp.def)*2;
        System.out.println(mp.name+"\n"+"hp: "+mp.hp+"\t攻击力: "+mp.atk+"\t防御力: "+mp.def);
        System.out.println(this.name+"\n"+"hp: "+this.hp+"\t攻击力: "+this.atk+"\t防御力: "+this.def+"\n");
    }
    public void 被反击 (Lv1MyPokemon mp){
        System.out.println(mp.name+"进行了反击，对"+this.name+"造成了10点伤害");
        this.hp-=10;
        System.out.println(mp.name+"\n"+"hp: "+mp.hp+"\t攻击力: "+mp.atk+"\t防御力: "+mp.def);
        System.out.println(this.name+"\n"+"hp: "+this.hp+"\t攻击力: "+this.atk+"\t防御力: "+this.def+"\n");
    }
    ...
    //随机选择技能释放
    protected void Select(Lv1MyPokemon mp){
        int a;
