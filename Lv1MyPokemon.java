...
public class Lv1MyPokemon extends Lv1Pokemon {
    //创建技能数组
    ...
    //设置精灵属性技能
    protected Lv1MyPokemon(String name, int hp, int atk, int def){
        this.name=name;
        this.atk=atk;
        this.hp=hp;
        this.def=def;
    ...
    //技能战斗方法
    private void fight1(Lv1RivalPokemon rp){
    ...
    private void fight2(Lv1RivalPokemon rp){
    ...
    //技能选择方法
    protected void  Select(Lv1RivalPokemon rp){
